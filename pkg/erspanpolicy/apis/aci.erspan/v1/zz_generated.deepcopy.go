...
func (in *ErspanPolicingType) DeepCopyInto(out *ErspanPolicingType) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ErspanPolicingType.
func (in *ErspanPolicingType) DeepCopy() *ErspanPolicingType {
	if in == nil {
		return nil
	}
	out := new(ErspanPolicingType)
	in.DeepCopyInto(out)
	return out
}
