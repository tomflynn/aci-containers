...
type AciV1Interface interface {
	...
	ErspanPoliciesGetter
}

// AciV1Client is used to interact with features provided by the aci.erspan group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) ErspanPolicies() ErspanPolicyInterface {
	return newErspanPolicies(c)
}
