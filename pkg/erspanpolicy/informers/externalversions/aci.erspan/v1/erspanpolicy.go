...
import (
	...
	v1 "github.com/noironetworks/aci-containers/pkg/erspanpolicy/listers/aci.erspan/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AciV1().ErspanPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AciV1().ErspanPolicies().Watch(context.TODO(), options)
			},
		},
		&acierspanv1.ErspanPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *erspanPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&acierspanv1.ErspanPolicy{}, f.defaultInformer)
}

func (f *erspanPolicyInformer) Lister() v1.ErspanPolicyLister {
	return v1.NewErspanPolicyLister(f.Informer().GetIndexer())
}
